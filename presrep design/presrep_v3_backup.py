...
for page_number in range(16):
    ...
    # Draw white filled rectangle (no border) only on pages 3, 7 (removed from pages 1 and 2)
    ...
    # PAGE 3 - Draw white rectangle and resilience score
    ...
    if page_number == 2:
        ...
        # Print resilience score (moved from page 2)
        print_score(canvas_obj, resilience_score, 450 + 20, 665 + 45 + 10)
    ...
    if page_number == 6:
        ...
        text_data = [
            ...
            ('开放性 O', O_score, 'left', vertices[1][0] - 5, vertices[1][1]),    # Top-right (moved 20pts left)
        ...
        # Print max_score in leftmost top right rectangle (moved 35pts lower)
        print_score(canvas_obj, max_score, 430 + 10, 650 + 60 + 20 - 35)
        
        # Print min_score (moved 35pts lower and 20pts to the right)
        print_score(canvas_obj, min_score, 430 + 10 + 25 + 20, 650 + 60 + 20 - 35)

    # ============================================================
    # RULER MODULE - REMOVED (no ruler overlay)
    # ============================================================
    # Ruler function call has been removed to create clean output
